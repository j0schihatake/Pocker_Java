...
public class Board {
     ...
     */
    public static Rectangle cart0 = new Rectangle(780,410, 28,25);

    /**
     * Карта на столе 1(слева направо):
     */
    public static Rectangle cart1 = new Rectangle(876,410, 28,25);

    /**
     * Карта на столе 2(слева направо):
     */
    public static Rectangle cart2 = new Rectangle(944,410, 28,25);

    /**
     * Карта на столе 3(слева направо):
     */
    public static Rectangle cart3 = new Rectangle(1030,410, 28,25);

    /**
     * Карта на столе 4(слева направо):
     */
    public static Rectangle cart4 = new Rectangle(1098,410, 28,25);

    /**
     * Карта на столе 5(слева направо):
     */
    public static Rectangle cart5 = new Rectangle(1166,410, 28,25);
